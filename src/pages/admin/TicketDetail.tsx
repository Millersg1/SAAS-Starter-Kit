...
function ReplyBubble({ reply }: { reply: Reply }) {
    ...
    return (
        <div className={`flex ${reply.is_admin ? "justify-end" : "justify-start"}`}>
            <div
    ...
    if (error) {
        return (
            <div className="space-y-4">
                <Link to="/admin/support" className="text-primary hover:underline flex items-center gap-2">
        ...
        <div className="space-y-6">
                ...
                <CardContent className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                        <span className="font-medium">
                            {ticket.user?.full_name || ticket.user?.email || "Customer"}
                        </span>
            ...
            {ticket.status !== "closed" && (
                <form onSubmit={handleReply} className="space-y-3">
                    <label className="block text-sm font-medium">Reply as Admin</label>
                    <textarea
                        value={replyMessage}
