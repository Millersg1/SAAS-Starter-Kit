...
interface ToastProps extends React.ComponentProps<typeof ToastPrimitives.Root>, VariantProps<typeof toastVariants> { }
...
type ToastPropsExport = React.ComponentProps<typeof Toast>;
