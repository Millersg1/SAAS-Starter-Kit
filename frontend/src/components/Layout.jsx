...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Lead Forms', href: '/lead-forms', icon: '📥' },
    ...
    { name: 'Brand Voice', href: '/brand-voice', icon: '🎨' },
    { name: 'Service Packages', href: '/packages', icon: '📦' },
    { name: 'Client Reports', href: '/client-reports', icon: '📋' },
    { name: 'Team Workload', href: '/workload', icon: '👥' },
    { name: 'Reputation', href: '/reputation', icon: '⭐' },
    { name: 'Funnels', href: '/funnels', icon: '🚀' },
    { name: 'Chat Widget', href: '/chat-widget', icon: '💬' },
