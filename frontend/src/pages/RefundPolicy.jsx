...
export default function RefundPolicy() {
  return (
    <div style={{ fontFamily: 'Arial, system-ui, -apple-system, Segoe UI, Roboto', margin: 0, background: '#f7f8fb', color: '#0b1220', minHeight: '100vh' }}>
      <SEO title="Refund Policy" description="SAAS Surface refund and cancellation policy for subscriptions." url="https://saassurface.com/refund-policy" />
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '28px 18px' }}>
        <div style={{ background: '#fff', border: '1px solid #e6e8ee', borderRadius: 16, padding: 22 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', alignItems: 'baseline' }}>
            <div>
              <h1 style={{ margin: '0 0 8px', fontSize: 28 }}>Refund &amp; Cancellation Policy</h1>
          ...
          <h2 style={{ margin: '22px 0 10px', fontSize: 18 }}>Cancellations</h2>
          <ul style={{ lineHeight: 1.55 }}>
            ...
            <li>After the 30-day guarantee window, cancellations do not result in a refund for the remaining unused portion of the billing period.</li>
          </ul>

          <h2 style={{ margin: '22px 0 10px', fontSize: 18 }}>Renewals</h2>
          <ul style={{ lineHeight: 1.55 }}>
            <li>Subscriptions renew automatically at the end of each billing period (monthly or annually).</li>
            <li>You will receive an email reminder before annual renewals.</li>
            <li>To avoid renewal charges, cancel before your billing period ends.</li>
          </ul>

          <h2 style={{ margin: '22px 0 10px', fontSize: 18 }}>Exceptions</h2>
          <p style={{ lineHeight: 1.55 }}>Refunds will not be issued for:</p>
          <ul style={{ lineHeight: 1.55 }}>
            <li>Requests made after the 30-day guarantee window on subsequent billing periods.</li>
            <li>Accounts terminated for violations of our Terms of Service or Acceptable Use Policy.</li>
            <li>Partial months or unused features within an active subscription period.</li>
          </ul>
